        ...
        <div class="flex justify-between h-12">
            <div class="flex">
                ...
                @if ($breadcrumbsData == null)
                    <div class="ml-5">{{ Breadcrumbs::render($breadcrumbs) }}</div>
                @else
                    <div class="ml-5">{{ Breadcrumbs::render($breadcrumbs, $breadcrumbsData) }}</div>
                @endif
            </div>
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                <div class="mr-5">
                    <button id="trigger-alert-test-btn"
                        class="text-gray-500 hover:text-gray-700 dark:hover:text-gray-300 transition-all">Alert
                    </button>
                </div>
                <div class="mr-5">
                    <button id="switchThemeBtn"
                        class="text-gray-500 hover:text-gray-700 dark:hover:text-gray-300 transition-all"><i

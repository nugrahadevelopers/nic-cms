<x-app-layout>
    <x-slot name="breadcrumbs">tags.create</x-slot>

    <x-card-container>
        <form action="{{ route('admin.blog.tags.create') }}" method="post">
            @csrf
    ...
    @push('js')
        <!-- Scripts -->
        <script src="{{ asset('assets/js/module/blog/tag/create.js') }}"></script>
    @endpush
</x-app-layout>
